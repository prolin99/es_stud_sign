    ...
    <{foreach key=key item=sign from=$data.kind_in }>
      ...
      <{ if ($data.admin) }>
        <form action="index.php?id=<{ $sign.id }>" method="post">
          <div class='row'>
            <span class='col-md-2 col-xs-3'>班級：</span>
            <span class='col-md-4 col-xs-5'>
              <{html_options name="admin_class_id" class="form-control" options=$data.class_list_c selected=$data.sel_class onchange="submit();" }>
            </span>
            <span class="alert alert-danger col-md-3 col-xs-4">管理員權限!!!!</span>
          </div>
        </form>
      <{else}>
          <h3> 班級：
              ...
              <fieldset>
                ...
                <{/if}>
                  ...
                  <h5>正取資料輸入(直接輸入座號，自動轉換姓名)</h5>
                    <div class="row">
                      <span class="label label-info col-md-2 col-xs-4"> 順序. 座號</span>
                      <{foreach key=key item=fi from=$sign.field_input }>
                      <span class="label label-info col-md-<{$fi[3]}> col-xs-<{$fi[3]}>">
                          <{$fi[1]}>
                      </span>
                        <{/foreach}>
                      <span class="label label-info col-md-4 col-xs-4">匯出資料欄</span>
                    </div>
                    ...
                    <{section name=ti start=0 loop=$sign.stud_get step=1 }>
                      ...
                      <div class="row" ord_id="<{$i}>">
                        ...
                        <{foreach key=key item=fi from=$sign.field_input }>
                          <{ if ($fi[2]=='d' ) }>
                            <!--     日期       -->
                            <span class="col-md-<{$fi[3]}> col-xs-<{$fi[3]}>">
                        ...
                        <{/foreach}>
                                    <!--     擷取欄         -->
                        <span class="col-md-4 col-xs-4" id="get_<{$i}>">
                          ...
                          <div class="row">
                            ...
                            <span class="col-md-1 col-xs-2">
                              <{if ($sign.need) }>
                                ...
                                <{/if}>
                              <{else}>
                                        <span class="label label-default" title="所在的年級無需填報">無需填報</span>
                              <{/if}>
                            </span>
                            ...
                            <{ else }>
                              <div class="row">
                                <span class="col-md-1 col-xs-2">
                                  <span class="label label-default ">過期</span>
                                </span>
                                <{/if}>
                                  ...
                                  <{if ($sign.d_days>0) }>
                                    <span class="label label-info">還有
                                      <{$sign.d_days}> 天</span>
                                    <span> 填報年級：
                                      <{$sign.input_classY}>
                                    </span>
